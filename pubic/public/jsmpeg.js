...
var jsmpeg = window.jsmpeg = function(url, opts) {
	...
	this.progressiveChunkSizeMax = 4 * 2048 * 2048;
...
//jsmpeg.prototype.socketBufferSize = 1024 * 1024; // 512kb each
//jsmpeg.prototype.socketBufferSize = 2048 * 2048; // 512kb each
